...
import { ChangePasswordDialog } from '../constants/components/change-password-dialog/change-password-dialog';
...
export class DialogService {
  ...
  openChangePaswordDialog(): MatDialogRef<ChangePasswordDialog> {

...
public class UserController {
    ...
    public ResponseEntity<MessageResponse> deleteUser(@PathVariable Long id, Authentication authentication) {
        String curentUserEmail = authentication.getName();
        return ResponseEntity.ok(userService.deleteUser(id, curentUserEmail));
    }
    ...
    public ResponseEntity<MessageResponse> toggleUserStatus(
        ...
        String curentUserEmail = authentication.getName();
        return ResponseEntity.ok(userService.toggleUserStatus(id, curentUserEmail));
    }
